...
<head>
	...
	<link rel="stylesheet" href="{{asset('assets/front/css/sliderman.css')}}">
			...
			<div class="row">
							...
							<ul >
										...
										<li style="display:inline;">
											<a href="{{ App\Models\Socialsetting::find(1)->facebook }}" class="facebook" target="_blank">
												<i class="fab fa-facebook" style="font-size: 1.4em"></i>
											</a>
										</li>
										@endif
										...
										<li style="display:inline; margin-left:10px;">
											...
											<i class="fab fa-twitter fa-2x" style="font-size: 1.4em"></i>
											</a>
										</li>
										@endif
										...
										<li style="display:inline; margin-left:10px;">
											<a href="{{ App\Models\Socialsetting::find(1)->linkedin }}" class="linkedin" target="_blank">
												<i class="fab fa-linkdin" style="font-size: 1.4em"></i>
											</a>
										</li>
										@endif
										...
										<li style="display:inline; margin-left:10px;">
											...
											<i class="fab fa-instagram fa-2x" style="font-size: 1.4em"></i>
											</a>
										</li>
										@endif
				...
				<div class="col-sm-6 col-lg-3">
					<div class="footer-widget recent-post-widget" style="">
						...
						<div class="icon-container2 d-flex" style="">
								<div class="smd"> 
									<a href="https://www.facebook.com/sharer/sharer.php?u=mayrasales.com" class="facebook" target="_blank"><i class="fab fa-facebook fa-2x" style="color: #fff; font-size: 25px"></i>
									</a>
								</div>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<div class="smd"> 
									<a href="http://www.facebook.com/dialog/send?app_id=3295714593783056&link=https://mayrasales.com&redirect_uri=https://www.mayrasales.com" class="facebook" target="_blank"><i class="fab fa-facebook-messenger fa-2x" style="color: #fff;font-size: 25px"></i>
									</a>
								</div>

								&nbsp;&nbsp;&nbsp;&nbsp;
								<div class="smd"> 
									<a href="https://wa.me/?text=I am using mayrasales.com" class="facebook" target="_blank"><i class="fab fa-whatsapp fa-2x" style="color: #fff;font-size: 25px"></i>
									</a>
								</div>
						</div>
					</div>
				...
				<div class="col-sm-6 col-lg-3">
					<div class="footer-widget recent-post-widget">
						...
						<div class="icon-container2 d-flex">
										<img class="icon-logo-QR-footer" src="{{asset('assets/images/android_qr.png')}}" alt="" height=40 style="margin-right: 10px">

									<a href="//play.google.com"><img src="{{asset('/assets/images/android-logo.png')}}" height=40 style="margin-right: 10px"></a>
												<img src="{{asset('/assets/images/google-play-badge.png')}}" alt="" height=40 style="margin-right: 10px">
...
<script type="text/javascript">
  ...
  var langg    = {!! json_encode($langg) !!};
	...
	<script src="{{asset('assets/front/js/sliderman.1.3.8.js')}}"></script>
