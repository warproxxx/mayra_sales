							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="{{ route('vendor-payment-index') }}">{{ __('Payment Gateways') }}</a>
											</li>
										</ul>
								</div>
							</div>
...
@section('scripts')
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('vendor-payment-datatables') }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 text-right">'+
        	'<a class="add-btn" data-href="{{route('vendor-payment-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
