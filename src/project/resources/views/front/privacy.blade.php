...
<ul>
    ...
    <li>
        <p>
            ...
            Agreement) refers to Mayara Technology Private Limited, Nepal.
        </p>
    </li>
    <li>
        <p>
    ...
    <li>
        <p>
            ...
            refers to the Website and the App.
        </p>
    </li>
    <li>
        <p>
    ...
    <li>
        <p>
            ...
            refers to any website or any social network website or application
    ...
    <li>
        <p>
            ...
            refers to MyraSales, accessible from
            <a href="https://mayrasales.com/" target="_blank">
                <u>https://</u>
                <u>MayraSales</u>
                <u>.com</u>
            </a>
            ,
            <u>
                <a href="https://MayraSales.com.np/">
                    https://MayraSales.com.np
                </a>
            </u>
            .
        </p>
    ...
    <li>
        <p>
            <strong>App </strong>
            refers to MyraSales, accessible from mobile (i.e. smartphones with
            android, ios or any other OS) application.
        </p>
    </li>
    <li>
        <p>
...
<ul>
    <li>
        <p>
            By email: Legal@mayrasales.com
        </p>
    </li>
    <li>
        <p>
            By visiting this page on our website: MayraSales.com
        </p>
    </li>
    <li>
        <p>
            By phone number: 9815393598
        </p>
    </li>
</ul>
<p>
    Privacy Policy for MyraSales
</p>
