      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="about-info">
            <h4 class="title">
              Terms and Conditions MayraSales
            </h4>
            <p>
...
<p>
    ...
    whether personally or on behalf of an entity (“you”) and [MayraSales](“we,”
    “us” or “our”), concerning your access to and use of the [MayraSales.com]
...
<p>
    Option 2: All users who are minors in the jurisdiction in which they reside
...
<p>
    ...
    property rights and unfair competition laws of the Nepal, foreign
...
<p>
    ...
    not accurately reflect the actual colors and details of the products.
</p>
<p>
...
<p>
We accept the following forms of payment:    <u>Online banking, third party digital payment method and Cash</u>. You
    ...
    time. All payments shall be in Nepalese Rupees i.e. NRS.
</p>
<p>
...
<p>
    ...
    the Site and the law of the country. Vendor must create and promote
    friendly and positive environment with the customers, other vendors and our
    staff. They can use this Site for limited period of time only as per their
    subscription duration. Subscription charge will be prepaid and vendors can
    subscribe this Site for monthly or yearly basis. Once the subscription
    duration is over they can renew their subscription. Vendor can deliver
    their products themselves or ask for assistance from our delivery team. If
    our team delivers the product to the customer ; delivery charge from the
    customer and certain charge from concerned vendor will be received by our
    delivery team. If vendor delivers their products they can receive the
    delivery charge from the customer themselves.
</p>
<p>
    Vendors can use Cash on Delivery (COD), online banking or allowed
    Third-Party digital payment method to get their payment from the customers.
    In case of Used products vendor must use special picture frame clearly
    displaying and informing the customers about the status of the product.
    Vendors can only get their payment through Cash on Delivery (COD) if the
    product being sold is Used product.
</p>
<p>
    In case of pre-payment from customers Vendors must deliver the product to
    the customer; if the vendor can’t deliver the product then they must fully
    refund the customer as soon as possible. If the product displayed in the
    Site by the vendor is different in (color, quantity, size or physical
    condition) than what is actually delivered to the customer then customer
    can claim for refund and return the product to the concerned vendor. In
...
<p>
    For Return/Refunds please contact the vendor themselves. Vendors are
    Third-Party businesses so this ‘Site’ that is MayraSales will absolutely
    not be responsible or guarantee any Return/Refunds of products bought from
...
<ol>
    ...
    <li>
        <p>
            your Contributions do not violate any international or state law
...
<p>
    ...
    either the Play Store or Apple Store or Google Play (each an “App
...
<p>
    ...
    conditions of this mobile application license contained in these Terms of
    Use or as otherwise required under applicable law, and you acknowledge that
...
<p>
    (4) you must comply with applicable third-party terms of agreement when
...
<p>
    (5) you acknowledge and agree that the App Distributors are third-party
    beneficiaries of the terms and conditions in this mobile application
    license contained in these Terms of Use, and that each App Distributor will
...
<p>
    Please be advised that pursuant to law you may be held liable for damages
    if you make material misrepresentations in a Notification. Thus, if you are
...
<p>
    ...
    downtime or discontinuance of the Site. Nothing in these Terms of Use will
...
<p>
    These Terms and conditions are governed by and constructed in accordance
...
<p>
    We have following measures for dispute resolutions. If the dispute does not
...
<p>
    ...
    informally for at least <strong>30</strong> days before initiating
...
<p>
    ...
    “Party” and collectively, the “Parties”) shall be finally and exclusively
    resolved by mutually agreed arbitration.
</p>
<p>
...
<p>
    In no event shall any Dispute brought by between vendors and customers
...
<p>
    ...
    rights; or (5) any overt harmful act toward any other user of the Site with
...
<p>
    Company name : Mayara Technology Private Limited
</p>
<p>
    Address : Acharya Line, Dharan-9, Sunsari
</p>
<p>
    Phone number : 9815393598
</p>
<p>
    Mail : Legal@mayrasales.com
</p>
<table width="630" cellspacing="0" cellpadding="1">
    <colgroup>
        <col width="293"/>
        <col width="37"/>
        <col width="293"/>
