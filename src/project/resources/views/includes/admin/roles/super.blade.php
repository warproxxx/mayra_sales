<li>
    ...
    <li>
        <a href="{{ route('admin-message-dispute') }}" class="accordion-toggle wave-effect"><i class="fas fa-fw fa-newspaper"></i><span>{{ __('Disputes') }}</span></a>
    </li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="menu3" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-user-image') }}"><span>{{ __('Default Image') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-vendor-subs') }}"><span>{{ __('Vendor Subscriptions') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-vendor-color') }}"><span>{{ __('Default Vendor Background') }}</span></a>
            </li>
