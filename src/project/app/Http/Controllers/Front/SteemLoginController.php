...
class SteemLoginController extends Controller
{
 ...
 public function store(Request $request)
 {
     ...
     $item_number = 'OPN-'.time().'-'.str_random(4);
    ...
    return redirect('https://steemlogin.com/sign/transfer?from=&to=steem-keeper&amount='. $item_amount . '%20STEEM&memo=' . $item_number);
 }
